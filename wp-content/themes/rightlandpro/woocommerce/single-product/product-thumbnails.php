	...
	foreach ( $attachment_ids as $attachment_id ){
		...
		if($image_attributes[0]!=''){
			...
			$markup .= '<li class="nav-item">';
				$markup .= '<a class="nav-link '.$class.'" id="'.$id.'-tab" data-toggle="tab" href="#'.$id.'" role="tab" aria-controls="'.$id.'" aria-selected="true"><img class="rightlandpro-thumb" src="'.current($image_attributes).'" alt="'.esc_attr__('image','rightlandpro').'" ></a>';
			$markup .= '</li>';
			$i++;
		}
	}
