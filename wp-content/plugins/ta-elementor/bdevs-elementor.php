...
final class BdevsElementor {
	...
	*/
	...
	public function init_widgets() {
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/bdevs-banner.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/case-studies-carousel.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/case-studies-grid.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/case-studies-gallery.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/video-content-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/working-progress-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/skills-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/goals-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/career-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/bdevs-list-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/bdevs-about-video-widget.php';
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsCaseStudiesCarousel() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsCaseStudiesGrid() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsCaseStudiesGallery() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsVideoContent() );		
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsWorkingProgress() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsSkills() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsGoals() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsCareer() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsList() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsAboutVideoContent() );
