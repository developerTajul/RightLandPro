...
final class Bdevs_toolkit {
	...
	function __construct() {
		...
		require_once BDEVS_TOOLKIT_DIR . '/inc/bdevs-case-study-post.php';
		...
		*/
		...
		require_once BDEVS_TOOLKIT_DIR . '/widgets/bdevs-service-categories.php';
		...
		require_once BDEVS_TOOLKIT_DIR . '/widgets/bdevs-contact-info-widget.php';
		require_once BDEVS_TOOLKIT_DIR . '/widgets/bdevs-info-btn-widget.php';
		require_once BDEVS_TOOLKIT_DIR . '/widgets/social-profiles-widget.php';
		require_once BDEVS_TOOLKIT_DIR . '/widgets/bdevs-info-social-widget.php';
...
/**
 * [bdevs_loadscript description]
 * @return [type] [description]
 */
function bdevs_loadscript(){
	$api_key = get_theme_mod('rightland-pro_map_api', 'AIzaSyBvEEMx3XDpByNzYNn0n62Zsq_sVYPx1zY');

	wp_enqueue_script('bdevs-google-map', '//maps.googleapis.com/maps/api/js?key='.$api_key, array('jquery'),false,false);
}

add_action('wp_enqueue_scripts','bdevs_loadscript');
