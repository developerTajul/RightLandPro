...
Class Latest_posts_sidebar_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts', 'Sidebar Posts Image', array(
			...
			?>
                    ...
                    <li>
                        ...
                        <div class="widget-posts-body">
                            <h6 class="widget-posts-title"><a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 7, ''); ?></a></h6>
