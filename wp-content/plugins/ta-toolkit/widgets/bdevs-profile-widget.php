<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'torun_profile_widget');
	function torun_profile_widget() {
		register_widget('torun_profile_widget');
	}
	
	
	class torun_Profile_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('torun_profile_widget',esc_html__('torun Info Widget','bdevs-toolkit'),array(
				'description' => esc_html__('torun Profile Widget','bdevs-toolkit'),
			));
		}
