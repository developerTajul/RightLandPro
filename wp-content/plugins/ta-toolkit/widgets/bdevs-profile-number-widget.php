<?php
	...
	add_action('widgets_init', 'torun_profile_number_widget');
	function torun_profile_number_widget() {
		register_widget('torun_profile_number_widget');
	}
	
	
	class torun_Profile_Number_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('torun_profile_number_widget',esc_html__('torun Info Number Widget','bdevs-toolkit'),array(
				'description' => esc_html__('torun Profile Number Widget','bdevs-toolkit'),
			));
		}
                            ...
                            <div class="footer-contact-info mb-30">
                                <div class="emmergency-call fix">
                                    ...
                                    <div class="emmergency-call-text f-left">
                                        <h6><?php print $phone_label; ?></h6>
                                        <span><?php print $phone_number; ?></span>
                                    </div>
                                </div>

			                    <div class="footer-logo dark-logo mb-35">
			                        <a href="<?php  print home_url(); ?>"><img src="<?php print $dark_logo; ?>" alt=""></a>
			                    </div>
                                ...
                                <div class="footer-emailing">
                                    <ul>
		                                <?php if($email_address): ?>
				                        	<li><i class="far fa-envelope"></i><?php print esc_html($email_address); ?></li>
				                    	<?php endif; ?>

										<?php if($website_link): ?>
				                        	<li><i class="far fa-clone"></i><?php print esc_url($website_link); ?></li>
				                        <?php endif; ?>

				                        <?php if($address_info): ?>
				                        	<li><i class="far fa-flag"></i><?php print esc_html($address_info); ?></li>
										<?php endif; ?>
                                    </ul>
                                </div>
                            </div>
